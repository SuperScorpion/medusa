...
//        this.markMapperList = MedusaGenUtils.genTagStrList(entityName + "Mapper.java", mapperPath, tag, "mapper");
    ...
    public Boolean process() {
        ...
        try {
            ...
            //写入service 和 impl
            return processService(cfg) && processServiceImpl(cfg);
    ...
    private Boolean processService(Configuration cfg) throws IOException, TemplateException {
...
//            MedusaCommonUtils.writeString2File(new File(resPath1), process1(), "UTF-8");
    ...
    private Boolean processServiceImpl(Configuration cfg) throws IOException, TemplateException {
